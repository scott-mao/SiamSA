...
__C.TRAIN.weightxffrange=8

__C.TRAIN.labelcls2range1=8

__C.TRAIN.labelcls2range2=6

__C.TRAIN.labelcls2range3=4
...
__C.TRAIN.num_scales = 3

__C.TRAIN.scale_step = 1.0375

__C.TRAIN.scale_lr = 0.590

__C.TRAIN.scale_penalty = 0.9745

__C.TRAIN.scale_head = [0.833, 1, 1.2]
# ------------------------------------------------------------------------ #
# Dataset options
# ------------------------------------------------------------------------ #
